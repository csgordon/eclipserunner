...
public class RunnerView extends ViewPart 
	...
	@SafeEffect public void modelChanged() {
		refresh();
	}
	...
	@SafeEffect public TreeViewer getViewer() {
		return viewer;
	}
	...
	protected void setupTreeContentProvider() {
        ...
        // Added this just to localize the errors - I was finding errors at call sites to this
	@SafeEffect public void refresh() {
		//Bug note by Sai Zhang
		//The following code should be wrapped by: 
		//   RunnerPlugin.getDisplay().syncExec(new Runnable() { public void run() { }}
		/* BUG -- Colin Gordon, confirming Sai's find */getViewer().refresh();
	}
